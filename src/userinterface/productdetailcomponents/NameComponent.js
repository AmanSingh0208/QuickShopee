...
export default function NameComponent({product,subcategoryname,productWeight}) {
...
//    var subcategoryname = ["Powder Detergent"]
//    var product = [{productlistname:"Tide Naturals",weight:"1Kg",subcategoryname:"Powder Detergent",}]
...
>
        ...
        >
          ...
          {product.productlistname}
                        ...
                        {product.productlistname} 
                        <div style={{fontFamily:"roboto",fontWeight:400,fontSize:16,lineHeight:"24px"}}>{weight}</div>
                        </div>
